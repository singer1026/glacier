...
public class IncomeWrap {
    public static Logger log = LoggerFactory.getLogger(IncomeWrap.class);
    private Integer id;
    ...
    private String incomeDateDisplay;
    ...
    public IncomeWrap(Income income) {
        try {
            PropertyUtils.copyProperties(this, income);
        } catch (Exception e) {
    ...
    public String getIncomeDateDisplay() {
        return incomeDateDisplay;
    }

    public void setIncomeDateDisplay(String incomeDateDisplay) {
        this.incomeDateDisplay = incomeDateDisplay;
    }
    ...
    public boolean getIsToday() {
        return DateUtils.isToday(incomeDate);
    }
}
