...
public class HasRoleMethod implements TemplateMethodModel {
    public static Logger log = LoggerFactory.getLogger(HasRoleMethod.class);
    ...
    public Object exec(List arguments) throws TemplateModelException {
        try {
            ...
            List<String> userRoleList = pvg.getUserRoleListByLoginId(pvgInfo.getLoginId());
            return PermissionUtils.contain(arguments, userRoleList);
        } catch (Exception e) {
